...
impl Vec3 {
    ...
    pub fn format_color(self) -> String {
        format!("{} {} {}", (255.999 * self[0]) as u64, (255.999 * self[1]) as u64, (255.999 * self[2]) as u64)
    }
}
...
impl Mul<f64> for Vec3 {
    ...
    fn mul(self, other: f64) -> Vec3 {
        Vec3 { e: [self[0] * other, self[1] * other, self[2] * other] }
    }
}
...
impl Mul<Vec3> for f64 {
    ...
    fn mul(self, other: Vec3) -> Vec3 {
        Vec3 { e: [self * other[0], self * other[1], self * other[2]] }
    }
}
